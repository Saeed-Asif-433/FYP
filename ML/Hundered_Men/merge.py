...
# ---------------- Load both CSVs ----------------
file1 = pd.read_csv("Hundered_players_stats.csv", header=0)  # Already has headers
file2 = pd.read_csv("hundered_league.csv", header=0)
...
# ---------------- Save ----------------
merged_sorted.to_csv("Hundered_data.csv", index=False)
