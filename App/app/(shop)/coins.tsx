      ...
      <View style={{ flex: 1 }}>
        ...
        <ImageBackground source={require('../../assets/images/bgufc3.png')} style={styles.image}>
          ...
          <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <CustomHeader name={'COINS'} onPress={() => router.push('/shop_screen')} />
          </View>
          {/*Middle View*/}
          <View style={{ flex: 6, flexDirection: 'row', marginVertical: '2%' }}>
            ...
            <View style={{ flex: 1, backgroundColor: '#1b1f2a', marginRight: '1%', marginLeft: '1%', }}>
              <View style={{ flex: 1, }}>
                <View style={{ alignSelf: 'center', borderBottomWidth: 3.5, borderColor: '#c6121f', marginTop: '1%', marginLeft: '1%' }}>
                  <Text style={{ fontWeight: 'bold', color: 'white', marginLeft: 2 }}>100 COINS</Text>
                </View>
              </View>
              <View style={{ flex: 7 }}>
                <Image source={require('../../assets/images/100coins.png')} style={styles.image} contentFit='contain' />
              </View>
            ...
            <View style={{ flex: 1, backgroundColor: '#1b1f2a', marginRight: '1%', marginLeft: '1%', }}>
              <View style={{ flex: 1, }}>
                <View style={{ alignSelf: 'center', borderBottomWidth: 3.5, borderColor: '#c6121f', marginTop: '1%', marginLeft: '1%' }}>
                  <Text style={{ fontWeight: 'bold', color: 'white', marginLeft: 2 }}>500 COINS</Text>
                </View>
              </View>
              <View style={{ flex: 7, }}>
                <Image source={require('../../assets/images/500coins.png')} style={styles.image} contentFit='contain' />
              </View>
              <View style={{ flex: 1, backgroundColor: 'grey', alignItems: 'center', justifyContent: 'center', borderRadius: 2 }}>
                <Text style={{ fontWeight: 'bold', color: 'white', textAlign: 'center' }}>RS 500</Text>
              </View>
            ...
            <View style={{ flex: 1, marginRight: '1%', marginLeft: '1%', }}>
              ...
              <View style={{ flex: 1, backgroundColor: '#1b1f2a', marginRight: '1%', marginLeft: '1%', }}>
                <View style={{ flex: 1, }}>
                  <View style={{ alignSelf: 'center', borderBottomWidth: 3.5, borderColor: '#c6121f', marginTop: '1%', marginLeft: '1%' }}>
                    <Text style={{ fontWeight: 'bold', color: 'white', marginLeft: 2 }}>1000 COINS</Text>
                  </View>
                </View>
                <View style={{ flex: 7, }}>
                  <Image source={require('../../assets/images/1000coins.png')} style={styles.image} contentFit='contain' />
                </View>
                <View style={{ flex: 1, backgroundColor: 'grey', alignItems: 'center', justifyContent: 'center', borderRadius: 2 }}>
                  <Text style={{ fontWeight: 'bold', color: 'white', textAlign: 'center' }}>RS 500</Text>
                </View>
            ...
            <View style={{ flex: 1, backgroundColor: '#1b1f2a', marginRight: '1%', marginLeft: '1%', }}>
              <View style={{ flex: 1, }}>
                <View style={{ alignSelf: 'center', borderBottomWidth: 3.5, borderColor: '#c6121f', marginTop: '1%', marginLeft: '1%' }}>
                  <Text style={{ fontWeight: 'bold', color: 'white', marginLeft: 2 }}>5000 COINS</Text>
                </View>
              </View>
              <View style={{ flex: 7, }}>
                <Image source={require('../../assets/images/5000coins.png')} style={styles.image} contentFit='contain' />
              </View>
              <View style={{ flex: 1, backgroundColor: 'grey', alignItems: 'center', justifyContent: 'center', borderRadius: 2 }}>
                <Text style={{ fontWeight: 'bold', color: 'white', textAlign: 'center' }}>RS 500</Text>
              </View>
